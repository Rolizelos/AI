...
client.on('guildMemberAdd', member => {
  ...
  let user = client.users.get(member.id);
    ...
    var kontrol;
    if (kurulus < 7) kontrol = client.emojis.get('657974944918929430')+' ``Güvenli Değil!``'
    if (kurulus > 7) kontrol = client.emojis.get('657974944726122514')+' ``Güvenli!``'
   ...
   member.guild.channels.get('650340908201672714').send(embed)
  })
});
